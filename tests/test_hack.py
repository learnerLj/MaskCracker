import json
from hack_metamask import decrypt_metamask_vault


import pytest

@pytest.mark.parametrize("vault, password", [
    (
...
def test_metamask_vault_decryption(vault, password):
    ...
    found = any(d["data"]['mnemonic'] == 'license recipe sunny wife pigeon again unfold car buyer pupil tortoise this' for d in decrypted)
